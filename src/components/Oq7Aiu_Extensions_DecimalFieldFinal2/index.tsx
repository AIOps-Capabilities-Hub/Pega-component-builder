...
import "./create-nonce";
import StyledOq7AiuExtensionsDecimalFieldFinal2Wrapper from "./styles";
import handleEvent from "./event-utils";
import { suggestionsHandler } from "./suggestions-handler";

interface Oq7AiuExtensionsDecimalFieldFinal2Props extends PConnFieldProps {
...
function Oq7AiuExtensionsDecimalFieldFinal2(
  props: Oq7AiuExtensionsDecimalFieldFinal2Props,
) {
  const {
    getPConnect,
    value,
  ...
  if (
    ...
    switch (displayMode) {
      case "DISPLAY_ONLY":
        return (
          <StyledOq7AiuExtensionsDecimalFieldFinal2Wrapper
...
export default withConfiguration(Oq7AiuExtensionsDecimalFieldFinal2);
